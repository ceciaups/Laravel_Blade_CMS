...
<form method="post" action="/console/careers/edit/{{$career->id}}" novalidate class="w3-margin-bottom">
    ...
    <table class="table-form">
        <tr>
            ...
            <td><input type="career" name="career" id="career" value="{{old('career', $career->career)}}" required></td>
        ...
        <tr>
            ...
            <td><textarea name="location" id="location" required>{{old('location', $career->location)}}</textarea></td>
        ...
        <tr>
            ...
            <td><input type="date" name="start_date" id="start_date" value="{{old('start_date', $career->start_date)}}" required></td>
        ...
        <tr>
            ...
            <td><input type="date" name="end_date" id="end_date" value="{{old('end_date', $career->end_date)}}" required></td>
            ...
            <td>
                @foreach ($skills as $key=>$skill)
                    ...
                    <label>
                        ...
                        {{in_array($skill->id, $career->skills()->pluck('skills.id')->toArray()) ? 'checked' : ''}}>
                        {{$skill->name}}
                    </label>
                @endforeach
            </td>
    ...
    <button type="submit" class="w3-button w3-green"><i class="fa-solid fa-pen"></i>Edit Career</button>
